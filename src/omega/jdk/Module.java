...
public class Module {
  ...
  public void readModule() {
    ...
    try {
      ...
      Screen.setStatus(
        "Exception while Reading Module : " + name,
        10,
  ...
  public static String convertSourcePathToPackagePath(String sourcePath) {
    if (sourcePath.endsWith(".java")) sourcePath =
      sourcePath.substring(0, sourcePath.lastIndexOf('.'));
    StringTokenizer tok = new StringTokenizer(sourcePath, File.separator);
    sourcePath = "";
    while (tok.hasMoreTokens()) sourcePath += tok.nextToken() + ".";
    sourcePath = sourcePath.substring(0, sourcePath.length() - 1);
    return (sourcePath.equals("") || !sourcePath.contains("."))
      ? null
      : sourcePath;
  }
