...
public class ConsoleSelector extends JDialog {
  ...
  public void init() {
    titleComp =
      new TextComp(
        "Specify System Terminal Launch Command",
        TOOLMENU_COLOR3,
        c2,
        c2,
        null
  ...
  public void apply() {
    dispose();
    DataManager.setConsoleCommand(
      nameField.getText() != null ? nameField.getText() : getPlatformTerminal()
    );
  }
  ...
  public void launchTerminal() {
    if (
      DataManager.getConsoleCommand() == null ||
      DataManager.getConsoleCommand().equals("")
    ) setVisible(true);
