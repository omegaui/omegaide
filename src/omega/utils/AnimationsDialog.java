...
public class AnimationsDialog extends JDialog {
  ...
  public AnimationsDialog(Screen screen) {
    ...
    File firstInstallFile = new File(
      ".omega-ide" + File.separator + ".shownAnimationsMenu"
    );
  ...
  public void init() {
    iconComp =
      new TextComp(IconManager.fluentanimationImage, 96, 96, c2, c2, c2, null);
    ...
    winIconComp =
      new TextComp(IconManager.fluentwindowsImage, 50, 50, c2, c2, c2, null);
    ...
    winLabelComp =
      new TextComp(
        "On Windows at least 4 GB RAM is required",
        c2,
        c2,
        TOOLMENU_COLOR1,
        null
    ...
    linuxIconComp =
      new TextComp(IconManager.fluentlinuxImage, 50, 50, c2, c2, c2, null);
    ...
    linuxLabelComp =
      new TextComp(
        "On Linux at least 2 GB RAM is required",
        c2,
        c2,
        TOOLMENU_COLOR1,
        null
    ...
    coreLabelComp =
      new TextComp(
        "With at least A Dual Core Processor",
        TOOLMENU_COLOR4,
        TOOLMENU_COLOR4,
        c2,
        null
