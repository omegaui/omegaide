...
public class ColorPicker extends JDialog {
  ...
  public void init() {
    ...
    redValueLabel =
      new TextComp("Red", TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR3, null);
    ...
    greenValueLabel =
      new TextComp("Green", TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR3, null);
    ...
    blueValueLabel =
      new TextComp("Blue", TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR3, null);
    ...
    alphaValueLabel =
      new TextComp("Alpha", TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR3, null);
    ...
    redValueField =
      new NoCaretField("255", "0", TOOLMENU_COLOR3, c2, TOOLMENU_COLOR2);
    ...
    redValueField.setOnAction(() -> {
      ...
      try {
        ...
        if (value >= 0 && value <= 255) redTileComp.pointer =
          value; else value = 1 / 0;
    ...
    greenValueField.setOnAction(() -> {
      ...
      try {
        int value = text.equals("") ? 0 : Integer.parseInt(text);
        if (value >= 0 && value <= 255) greenTileComp.pointer =
          value; else value = 1 / 0;
    ...
    blueValueField.setOnAction(() -> {
      ...
      try {
        int value = text.equals("") ? 0 : Integer.parseInt(text);
        if (value >= 0 && value <= 255) blueTileComp.pointer =
          value; else value = 1 / 0;
    ...
    alphaValueField.setOnAction(() -> {
      ...
      try {
        int value = text.equals("") ? 0 : Integer.parseInt(text);
        if (value >= 0 && value <= 255) alphaValue = value; else value = 1 / 0;
    ...
    colorCodeField =
      new NoCaretField("#FFFFFF", TOOLMENU_COLOR4, c2, TOOLMENU_COLOR1);
        ...
        () -> {
          Toolkit
            ...
            .setContents(
              new StringSelection(
                "\"#" +
                Integer.toHexString(previewColor.getRGB()).substring(2) +
                "\""
              ),
              null
            );
  ...
  public void genPreview() {
    previewColor =
      new Color(
        redTileComp.pointer,
        greenTileComp.pointer,
        blueTileComp.pointer,
        alphaValue
      );
  ...
  private class ColorComp extends JComponent {
    ...
    public void paint(Graphics graphics) {
      ...
      g.setPaint(
        new GradientPaint(0, 0, Color.BLACK, getWidth(), getHeight(), color)
      );
      g.fillRoundRect(0, 0, getWidth(), getHeight(), 10, 10);
      g.setColor(c2);
