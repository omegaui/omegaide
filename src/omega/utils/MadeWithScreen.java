...
public class MadeWithScreen extends JDialog {
  ...
  public void init() {
    ...
    rImageComp =
      new TextComp(IconManager.fluentfileImage, 50, 50, c2, c2, c2, null);
    ...
    TextComp rMessage = new TextComp(
      "with theming tweaks",
      c2,
      c2,
      TOOLMENU_COLOR4,
    ...
    lafImageComp =
      new TextComp(IconManager.fluentsettingsImage, 50, 50, c2, c2, c2, null);
    ...
    TextComp lafMessage = new TextComp(
      "with minor tweaks",
      c2,
      c2,
      TOOLMENU_COLOR4,
    ...
    lafMessage.setBounds(
      0,
      lafLinkComp.getHeight() - 25,
      lafLinkComp.getWidth(),
      25
    );
    ...
    fluentImageComp =
      new TextComp(IconManager.fluenticons8Logo, 50, 50, c2, c2, c2, null);
    ...
    TextComp fluentMessage = new TextComp(
      "without any tweaks",
      c2,
      c2,
      TOOLMENU_COLOR4,
    ...
    fluentMessage.setBounds(
      0,
      fluentLinkComp.getHeight() - 25,
      fluentLinkComp.getWidth(),
      25
    );
    ...
    jetImageComp =
      new TextComp(IconManager.fluentjetbrainsLogo, 50, 50, c2, c2, c2, null);
    ...
    TextComp jetMessage = new TextComp(
      "with theming tweaks",
      c2,
      c2,
      TOOLMENU_COLOR4,
    ...
    omegauiImageComp =
      new TextComp(IconManager.ideImage64, 64, 64, c2, c2, c2, null);
    ...
    TextComp omegaMessage = new TextComp(
      "super flexible ui elements",
      c2,
      c2,
      TOOLMENU_COLOR4,
      null
    );
    omegaMessage.setBounds(
      0,
      omegauiLinkComp.getHeight() - 25,
      omegauiLinkComp.getWidth(),
      25
    );
