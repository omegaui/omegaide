...
public class SDKSelector extends JDialog {
      ...
      new JScrollPane(panel) {
        ...
        public void paint(Graphics graphics) {
          if (boxs.isEmpty()) {
            ...
            g.setFont(PX14);
            g.drawString(
              "No JDKs found at the specified path!",
              getWidth() /
              2 -
              g
                .getFontMetrics()
                .stringWidth("No JDKs found at the specified path!") /
              2,
              getHeight() /
              2 -
  ...
  private void resolvePath() {
    ...
    if (files == null) {
      omega.Screen.setStatus(
        "No JDKs found in \"" + pathJava + "\"",
        10,
    ...
    for (File file : files) {
      ...
      if (release != null) {
        TextComp box = new TextComp(
          file.getName() + "(" + release + ")",
