...
public class FontChooser extends JDialog {
  ...
  public void init() {
    ...
    fontFamilyPanel =
      new FlexPanel(null, TOOLMENU_COLOR1_SHADE, TOOLMENU_COLOR3_SHADE);
    ...
    fontScrollPane.setBounds(
      10,
      40,
      fontFamilyPanel.getWidth() - 20,
      fontFamilyPanel.getHeight() - 50
    );
    fontScrollPane.setBackground(c2);
    fontFamilyPanel.add(fontScrollPane);

    fontPanel.setPreferredSize(
      new Dimension(fontScrollPane.getWidth(), fontScrollPane.getHeight())
    );

    searchField =
      new NoCaretField("", "Search Font", TOOLMENU_COLOR3, c2, TOOLMENU_COLOR2);
    ...
    sampleField =
      new NoCaretField("Hello World", "", TOOLMENU_COLOR3, c2, TOOLMENU_COLOR2);
    ...
    buildComp.setToggleListener(value -> {
      sampleField.setFont(
        new Font(
          sampleField.getFont().getName(),
          value ? Font.BOLD : Font.PLAIN,
          fontSize
        )
      );
    });
    ...
    sizeField.setOnAction(() -> {
      ...
      sampleField.setFont(
        new Font(
          sampleField.getFont().getName(),
          buildComp.isOn() ? Font.BOLD : Font.PLAIN,
          fontSize
        )
      );
    });
  ...
  public void prepareView(String fontName) {
    ...
    fontSize = s;
    sampleField.setFont(
      new Font(fontName, buildComp.isOn() ? Font.BOLD : Font.PLAIN, fontSize)
    );
  ...
  public void setVisible(boolean value) {
    if (value) {
      if (fontList.isEmpty()) prepareFonts();
    }
