...
public class ModuleView extends JDialog{
	...
	private class Dock extends JComponent {
		protected Dock(){
			...
			TextComp iconBtn = new TextComp("x", omega.utils.UIManager.c1, omega.utils.UIManager.c2, omega.utils.UIManager.c3, ()->ModuleView.this.setVisible(false));
			...
			TextComp title = new TextComp("Module Manager -Manage Project Modules", omega.utils.UIManager.c1, omega.utils.UIManager.c3, omega.utils.UIManager.c2, ()->{});
			...
			TextComp addBtn = new TextComp("+", omega.utils.UIManager.c1, omega.utils.UIManager.c2, omega.utils.UIManager.c3, ()->addPath());
			...
			TextComp rmBtn = new TextComp("-", omega.utils.UIManager.c1, omega.utils.UIManager.c2, omega.utils.UIManager.c3, ()->removePath(textArea.getCaretLineNumber()));
			...
			final class Help extends JWindow{
				...
				void init(){
					...
					ins.setEditable(false);
                         ins.setCurrentLineHighlightColor(omega.utils.UIManager.c1);
			...
			TextComp howBtn = new TextComp("?", omega.utils.UIManager.c1, omega.utils.UIManager.c2, omega.utils.UIManager.c3, ()->{});
	...
	private void init(){
		...
		textArea.setFont(fontX);
          textArea.setCurrentLineHighlightColor(omega.utils.UIManager.c1);
