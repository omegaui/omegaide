...
public class ChoiceDialog extends JDialog{
     ...
     public ChoiceDialog(omega.Screen screen){
     	super(screen);
          setUndecorated(true);
          setSize(600, 40);
     ...
     public void init(){
           ...
           ch1.setFont(omega.settings.Screen.PX16);
           ch2.setFont(omega.settings.Screen.PX16);
           cancel.setFont(omega.settings.Screen.PX16);
