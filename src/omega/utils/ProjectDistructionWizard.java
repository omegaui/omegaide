...
public class ProjectDistructionWizard extends JDialog {
  ...
  public void init() {
    ...
    imageComp =
      new TextComp(
        IconManager.fluentsadImage,
        48,
        48,
        "You should have a backup before you proceed!",
        c2,
        c2,
        c2,
        null
    ...
    textComp.setBounds(
      10,
      imageComp.getY() + imageComp.getHeight() + 10,
      getWidth() - 20,
      25
    );
    ...
    text1Comp.setBounds(
      10,
      textComp.getY() + textComp.getHeight() + 10,
      getWidth() - 20,
      25
    );
            ...
            Screen
              ...
              .triggerReaction(
                PluginReactionEvent.genNewInstance(
                  PluginReactionEvent.EVENT_TYPE_PROJECT_DELETED,
                  this,
                  null
                )
              );
