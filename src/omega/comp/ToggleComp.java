...
public class ToggleComp extends TextComp {
    ...
    addMouseListener(
      new MouseAdapter() {
        ...
        public void mousePressed(MouseEvent e) {
          if (toggleEnabled) ToggleComp.this.state = !ToggleComp.this.state;
          repaint();
          if (
            ToggleComp.this.toggleListener != null && e.getButton() == 1
  ...
  public void draw(Graphics2D g) {
    ...
    if (image != null) {
      g.drawImage(
        image.getScaledInstance(w, h, BufferedImage.SCALE_SMOOTH),
        getHeight() / 2 - w / 2,
        getHeight() / 2 - h / 2,
        w,
        h,
