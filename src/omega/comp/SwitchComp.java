...
public class SwitchComp extends JComponent {
  ...
  public void paint(Graphics graphics) {
    ...
    g.setPaint(
      isEnabled()
        ? new GradientPaint(0, 0, color3, getWidth(), getHeight(), color2)
        : new GradientPaint(0, 0, color2, getWidth(), getHeight(), color3)
    );
    ...
    if (on) {
      if (enter) {
        ...
        paintBall(
          g,
          getWidth() - offset + 2 - part - 4,
          getHeight() / 2 - (part + 4) / 2,
          part + 4,
          part + 4
        );
      }
