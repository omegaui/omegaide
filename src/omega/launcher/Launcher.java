...
public class Launcher extends JFrame {
  ...
  public void init() {
    ...
    TextComp imageComp = new TextComp(
      (BufferedImage) IconManager
    ...
    imageComp.addMouseMotionListener(
      new MouseAdapter() {
        @Override
        public void mouseDragged(MouseEvent e) {
          setLocation(
            e.getXOnScreen() - pressX - 50,
            e.getYOnScreen() - pressY - 50
          );
        }
      }
    );
    ...
    TextComp openComp = new TextComp(
      "Open a Project",
      TOOLMENU_COLOR3,
    ...
    TextComp nuComp = new TextComp(
      "New Universal Project",
      TOOLMENU_COLOR3,
      TOOLMENU_COLOR3_SHADE,
      c2,
      () -> {
    ...
    TextComp workComp = new TextComp(
      "Change Workspace",
      TOOLMENU_COLOR3,
      TOOLMENU_COLOR3_SHADE,
      c2,
    ...
    TextComp infoComp = new TextComp(
      "About",
      TOOLMENU_COLOR3,
      TOOLMENU_COLOR3_SHADE,
      c2,
