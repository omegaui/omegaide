...
public class BasicCodeHighlighter {
  ...
  public static synchronized boolean canComputeBackground(
    RSyntaxTextArea textArea,
    Token t
  ) {
    return (
      textArea.getSyntaxEditingStyle() == textArea.SYNTAX_STYLE_JAVA &&
      switch (t.getType()) {
  ...
  public static synchronized boolean canComputeForeground(
    RSyntaxTextArea textArea,
    Token t
  ) {
    return (
