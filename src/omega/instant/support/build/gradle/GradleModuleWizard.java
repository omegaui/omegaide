...
public class GradleModuleWizard extends JDialog {
  ...
  public void init() {
    titleComp =
      new TextComp("Gradle Module Wizard", TOOLMENU_COLOR3, c2, c2, null);
    ...
    result2 =
      new TextComp("", TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR3, null);
    result2.setBounds(
      languagePanel.getX() + 10,
      330,
      languagePanel.getWidth() - 20,
      25
    );
