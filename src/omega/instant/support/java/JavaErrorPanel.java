...
public class JavaErrorPanel extends FlexPanel {
  ...
  public void init() {
    ...
    errorLabel.setBounds(
      errorCountComp.getX() + errorCountComp.getWidth() + 2,
      10,
      55,
      getHeight() - 20
    );
    ...
    warningLabel.setBounds(
      warningCountComp.getX() + warningCountComp.getWidth() + 2,
      10,
      70,
      getHeight() - 20
    );
  ...
  public void relocate() {
    ...
    setLocation(
      (rect.x + rect.width) - getWidth() - 20,
      (rect.y + rect.height) - getHeight() - 15
    );
  }
}
