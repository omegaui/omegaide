...
public class ArgumentWindow extends JDialog {
  ...
  public void init() {
    ...
    scrollPane.setBounds(
      5,
      5,
      argContainerPanel.getWidth() - 10,
      argContainerPanel.getHeight() - 10
    );
    ...
    RTextField field = new RTextField(
      "Command Name",
      "",
      TOOLMENU_COLOR3,
      c2,
  ...
  public void loadView(LinkedList<String> commands) {
    ...
    RTextField mfield = new RTextField(
      "Command Name",
      "",
      TOOLMENU_COLOR3,
      c2,
    ...
    mainPanel.setPreferredSize(
      new Dimension(scrollPane.getWidth(), blockY + 25)
    );
  ...
  public LinkedList<String> getCommand() {
    ...
    fields.forEach(field -> {
      if (field.hasText()) commands.add(field.getText());
    });
