...
public class ListMaker extends JComponent {
  ...
  public ListMaker(String ext, String container, String dir, boolean quoted) {
    ...
    this.quoted = quoted;
    if (quoted) quoteComp.setColors(
      c2,
      TOOLMENU_COLOR3_SHADE,
      c2
    ); else quoteComp.setColors(TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR2);
  }
  ...
  public void init() {
    ...
    quoteComp =
      new TextComp(
        IconManager.fluentcommaImage,
        25,
        25,
        "Surround Paths within quotes",
        TOOLMENU_COLOR3_SHADE,
        c2,
        TOOLMENU_COLOR2,
        () -> {
          ...
          if (!selections.isEmpty()) {
            ...
            dirComp.setText(
              dirComp
                .getToolTipText()
                .substring(
                  dirComp.getToolTipText().lastIndexOf(File.separator) + 1
                )
            );
          }
        }
    ...
    TextComp enableComp = new TextComp(
    ...
    enableComp.setRunnable(() -> {
      ...
      if (!isEnabled()) enableComp.setColors(
        c2,
        TOOLMENU_COLOR2_SHADE,
        c2
      ); else enableComp.setColors(TOOLMENU_COLOR3_SHADE, c2, TOOLMENU_COLOR2);
    });
