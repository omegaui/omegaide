...
public class RemotePluginComp extends FlexPanel {
  ...
  public RemotePluginComp(
    PluginStore pluginStore,
    RemotePluginInfo remotePluginInfo,
    int width,
    int height
  ) {
    super(null, c2, null);
    ...
    addMouseListener(
      new MouseAdapter() {
        ...
        public void mousePressed(MouseEvent e) {
          if (remotePluginView == null) remotePluginView =
            new RemotePluginView(RemotePluginComp.this);
  ...
  public void init() {
    ...
    nameComp =
      new TextComp(
        remotePluginInfo.name + " " + remotePluginInfo.version,
        c2,
        c2,
        PluginCategory.getSuitableColor(remotePluginInfo.category),
        null
      );
    ...
    sizeComp =
      new TextComp(remotePluginInfo.size, c2, c2, TOOLMENU_COLOR5, null);
    ...
    descriptionComp =
      new TextComp(remotePluginInfo.description, c2, c2, TOOLMENU_COLOR3, null);
    descriptionComp.setBounds(
      sizeComp.getX() + sizeComp.getWidth() + 2,
      30,
      getWidth() - getHeight() - 100 - 100 - 100,
      25
    );
    ...
    installComp =
      new TextComp(
        pluginStore.pluginManager.isPluginInstalled(remotePluginInfo.fileName)
          ? "Uninstall"
          : "Install",
    ...
    categoryComp =
      new TextComp(
        (
          remotePluginInfo.category.equals("")
            ? "All"
            : remotePluginInfo.category.toUpperCase()
        ),
        back2,
        back2,
        glow,
  ...
  public void installAction() {
    if (
      ...
      pluginStore.pluginManager.uninstallPlugin(
        pluginStore,
  ...
  public void loadIcon() {
    try {
      ...
      System.err.println(
        "Unable to Read Icon of Plugin \"" + remotePluginInfo.name + "\""
      );
      e.printStackTrace();
    }
  }
