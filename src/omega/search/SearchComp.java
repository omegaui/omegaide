...
public class SearchComp extends FlexPanel implements MouseListener {
  ...
  public void initUI() {
    ...
    parentComp.setBounds(
      nameComp.getX(),
      nameComp.getY() + nameComp.getHeight() + 2,
      nameComp.getWidth(),
      nameComp.getHeight()
    );
    ...
    tagComp.setBounds(
      getWidth() - 75,
      getHeight() - parentComp.getHeight(),
      70,
      parentComp.getHeight()
    );
  ...
  public void set(boolean enter) {
    if (enter) mouseEntered(null); else mouseExited(null);
  }
  ...
  public String getExtension() {
    ...
    if (
      name.equalsIgnoreCase("sh") ||
      name.equalsIgnoreCase("run") ||
      name.equalsIgnoreCase("bat") ||
      name.equalsIgnoreCase("cmd")
    ) name = "Shell";
    return name;
  }
}
