...
public class DataMember {
  ...
  public DataMember(
    ...
    this.name = name;
    if (parameters != null) this.parameters = parameters.trim();
    if (modifier.contains(" ")) {
      String[] mods = modifier.split(" ");
      for (String mod : mods) modifiers.add(mod.trim());
    } else {
  ...
  public String getRepresentableValue() {
    if (access.equals("custom hint")) return name + " - " + type;
    if (name.contains(".") & parameters != null) return null;
    if (parameterCount != 0) {
