...
public class OPopupWindow extends JDialog {
  ...
  public OPopupWindow createItem(
    String name,
    BufferedImage image,
    Runnable run
  ) {
  ...
  public OPopupWindow setEnabled(String name, boolean value) {
    if (getItem(name) != null) getItem(name).setEnabled(value);
    return this;
  }
  ...
  public void setVisible(boolean value) {
    ...
    if (!value && closeOperations != null) closeOperations.run(); else if (
      value
    ) {
      new Thread(() -> {
  ...
  public Component add(Component c) {
    if (scrollable) return panel.add(c); else return super.add(c);
  }

  @Override
  public void remove(Component c) {
    if (scrollable) panel.remove(c); else super.add(c);
  }
  ...
  public static OPopupWindow gen(
    String name,
    Window owner,
    int animaTime,
    boolean scrollable
