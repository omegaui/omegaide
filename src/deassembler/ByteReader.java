package deassembler;
/*
    This class disassembles the ByteCode of the class provided.
...
public class ByteReader {
	...
	public ByteReader(String className){
		if(!className.contains(" ")) {
			ide.Screen.getScreen().getToolMenu().setTask("Unpacking " + className);
			this.className = className;
			read();
			ide.Screen.getScreen().getToolMenu().setTask("Hover to see Memory Statistics");
		}
	}
