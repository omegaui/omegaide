...
public class DataBlock {
     ...
     public String code;
     public DataBlock(DataMember block){
          this.block = block;
          depthMembers.clear();
     }
          ...
          while(tok.hasMoreTokens()){
               ...
               if(line.contains("try") && line.contains("(") && line.contains(")") && line.contains("=")){
                    ...
                    if(part.contains("=")){ //Verifying the line still contains '='
                         ...
                         String type = part.substring(0, part.indexOf(' ')).trim();
               ...
               if(line.contains("for")){
                    if(line.contains("(") && line.contains(")")){
                         ...
                         if(line.contains(";")){
                              ...
                              if(line.contains(",")){
                                   ...
                                   while(ok.hasMoreTokens()){
                                        ...
                                        if(t.contains(" ")){
                                             ...
                                             String type = t.substring(0, t.indexOf(' ')).trim();
                                             if(name.contains("(") || name.contains(")")) continue;
                                             depthMembers.add(new DepthMember("", "", type, name, null, braces));
                                        }
                                   }
                              ...
                              String type = exp.substring(0, exp.indexOf(' ')).trim();
                              if(name.contains("(") || name.contains(")")) continue;
                              depthMembers.add(new DepthMember("", "", type, name, null, braces));
                         }
                    }
