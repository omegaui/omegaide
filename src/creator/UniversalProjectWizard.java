...
public class UniversalProjectWizard extends JDialog{
     ...
     public void init(){
     	TextComp closeComp = new TextComp("x", c1, c2, c3, ()->setVisible(false));
          ...
          nameField.setFont(settings.Screen.PX18);
          ...
          rootComp.setFont(settings.Screen.PX18);
          rootComp.setArc(0, 0);
          add(rootComp);
          ...
          dirArea.setFont(settings.Screen.PX14);
          ...
          createBtn.setFont(settings.Screen.PX18);
          add(createBtn);
     }
