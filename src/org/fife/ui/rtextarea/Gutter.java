...
public class Gutter extends JPanel {
   ...
   */
  public static final Color DEFAULT_ACTIVE_LINE_RANGE_COLOR = new Color(
    51,
    153,
    255
  );
  ...
  public Gutter(RTextArea textArea) {
    ...
    lineNumberFont =
      new Font(
        ...
        omega.utils.UIManager.fontState,
  ...
  void setTextArea(RTextArea textArea) {
    ...
    if (textArea != null) {
      RTextAreaEditorKit kit = (RTextAreaEditorKit) textArea
        .getUI()
  ...
  private class TextAreaListener
    ...
    implements
      DocumentListener, PropertyChangeListener, ActiveLineRangeListener {
    ...
    public void propertyChange(PropertyChangeEvent e) {
      ...
      if (
        ...
        for (int i = 0; i < getComponentCount(); i++) {
          AbstractGutterComponent agc = (AbstractGutterComponent) getComponent(
            i
          );
