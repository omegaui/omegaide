...
public abstract class RTextAreaBase extends JTextArea {
  ...
  private static final Color DEFAULT_CARET_COLOR = new ColorUIResource(
    255,
    51,
    51
  );
  ...
  private static final Color DEFAULT_MARGIN_LINE_COLOR = new Color(
    255,
    224,
    224
  );
  ...
  public void setCurrentLineHighlightColor(Color color) {
    color =
      omega.utils.UIManager.isDarkMode()
        ? new Color(249, 56, 0, 20)
