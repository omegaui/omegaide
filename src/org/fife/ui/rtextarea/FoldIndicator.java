...
public class FoldIndicator extends AbstractGutterComponent {
  ...
  protected void paintComponent(Graphics g) {
    ...
    int y =
      topLine *
      cellHeight +
      (cellHeight - collapsedFoldIcon.getIconHeight()) /
      2;
  ...
  private void paintComponentWrapped(Graphics g) {
    ...
    while (y < visibleBottom && line < lineCount) {
      int curLineH = LineNumberList.getChildViewBounds(
        v,
        line,
        visibleEditorRect
      )
      ...
      if (fold != null) {
        ...
        if (fold.isCollapsed()) {
          collapsedFoldIcon.paintIcon(this, g, x, y);
          y +=
            LineNumberList.getChildViewBounds(v, line, visibleEditorRect)
              .height;
  ...
  private class Listener
    ...
    public void mouseMoved(MouseEvent e) {
      ...
      if (
        newSelectedFold != foldWithOutlineShowing &&
