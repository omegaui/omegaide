...
public class RSyntaxTextAreaEditorKit extends RTextAreaEditorKit {
  ...
  public static final String rstaCloseCurlyBraceAction =
    "RSTA.CloseCurlyBraceAction";
  public static final String rstaCloseMarkupTagAction =
    "RSTA.CloseMarkupTagAction";
  public static final String rstaCollapseAllFoldsAction =
    "RSTA.CollapseAllFoldsAction";
  public static final String rstaCollapseAllCommentFoldsAction =
    "RSTA.CollapseAllCommentFoldsAction";
  public static final String rstaCollapseFoldAction = "RSTA.CollapseFoldAction";
  public static final String rstaCopyAsStyledTextAction =
    "RSTA.CopyAsStyledTextAction";
  public static final String rstaDecreaseIndentAction =
    "RSTA.DecreaseIndentAction";
  public static final String rstaExpandAllFoldsAction =
    "RSTA.ExpandAllFoldsAction";
  ...
  public static final String rstaGoToMatchingBracketAction =
    "RSTA.GoToMatchingBracketAction";
  ...
  public static final String rstaToggleCurrentFoldAction =
    "RSTA.ToggleCurrentFoldAction";
    ...
    public void actionPerformedImpl(ActionEvent e, RTextArea textArea) {
      ...
      try {
        ...
        if (alignCurlyBraces) {
          ...
          bracketInfo =
            RSyntaxUtilities.getMatchingBracketPosition(rsta, bracketInfo);
          if (bracketInfo.y > -1) {
            try {
  ...
  public static class CloseMarkupTagAction extends RecordableTextAction {
    ...
    public void actionPerformedImpl(ActionEvent e, RTextArea textArea) {
      ...
      if (
        doc.getLanguageIsMarkup() &&
        doc.getCompleteMarkupCloseTags() &&
        !selection &&
        rsta.getCloseMarkupTags() &&
        dot > 1
      ) {
        try {
  ...
  public static class DecreaseIndentAction extends RecordableTextAction {
     ...
     */
    private void handleDecreaseIndent(Element elem, Document doc, int tabSize)
      throws BadLocationException {
      int start = elem.getStartOffset();
  ...
  public static class DumbCompleteWordAction
    ...
    protected int getPreviousWord(RTextArea textArea, int offs)
      ...
      while (prevWordStart == -1 && line > 0) {
        ...
        elem = root.getElement(line);
        prevWordStart =
          getPreviousWordStartInLine(doc, elem, elem.getEndOffset());
      }

      return prevWordStart;
    }

    private int getPreviousWordStartInLine(
      RSyntaxDocument doc,
      Element elem,
      int offs
    ) throws BadLocationException {
    ...
    private static int getWordStartImpl(
      RSyntaxDocument doc,
      Element elem,
      int offs
    ) throws BadLocationException {
  ...
  public static class InsertBreakAction
    ...
    private static int getOpenBraceCount(
      RSyntaxDocument doc,
      int languageIndex
    ) {
      int openCount = 0;
     ...
     */
    protected void handleInsertBreak(
    ...
    private void insertNewlineWithAutoIndent(RSyntaxTextArea sta) {
      try {
        ...
        if (nonWhitespacePos == -1) {
          if (
            leadingWS.length() == len && sta.isClearWhitespaceLinesEnabled()
          ) {
    ...
    private void possiblyCloseCurlyBrace(
      RSyntaxTextArea textArea,
      String leadingWS
    ) {
      RSyntaxDocument doc = (RSyntaxDocument) textArea.getDocument();
      ...
      if (RSyntaxTextArea.getTemplatesEnabled()) {
        ...
        if (doc != null) {
          try {
            ...
            CodeTemplate template = manager == null
              ? null
