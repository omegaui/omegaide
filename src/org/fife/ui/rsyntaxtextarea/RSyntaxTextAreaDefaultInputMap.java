...
public class RSyntaxTextAreaDefaultInputMap extends RTADefaultInputMap {
  ...
  public RSyntaxTextAreaDefaultInputMap() {
    ...
    put(
      ...
      RSyntaxTextAreaEditorKit.rstaCloseCurlyBraceAction
    );

    put(
      KeyStroke.getKeyStroke('/'),
      RSyntaxTextAreaEditorKit.rstaCloseMarkupTagAction
    );
    int os = RSyntaxUtilities.getOS();
    if (
      os == RSyntaxUtilities.OS_WINDOWS || os == RSyntaxUtilities.OS_MAC_OSX
    ) {
    ...
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_OPEN_BRACKET, defaultMod),
      RSyntaxTextAreaEditorKit.rstaGoToMatchingBracketAction
    );
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_SUBTRACT, defaultMod),
      RSyntaxTextAreaEditorKit.rstaCollapseFoldAction
    );
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_ADD, defaultMod),
      RSyntaxTextAreaEditorKit.rstaExpandFoldAction
    );
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_DIVIDE, defaultMod),
      RSyntaxTextAreaEditorKit.rstaCollapseAllFoldsAction
    );
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_MULTIPLY, defaultMod),
    ...
    put(
      KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, defaultShift),
