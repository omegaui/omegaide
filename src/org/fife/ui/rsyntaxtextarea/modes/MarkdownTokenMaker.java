  ...
  public org.fife.ui.rsyntaxtextarea.Token yylex() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 38:
          {
            addToken(start, zzStartRead + 2, Token.FUNCTION);
            yybegin(YYINITIAL);
          }
        case 47:
          break;
        ...
        case 30:
          {
            addToken(start, zzStartRead + 1, Token.RESERVED_WORD_2);
            yybegin(YYINITIAL);
          }
        case 50:
          break;
        ...
        case 39:
          {
            addToken(start, zzStartRead + 2, Token.PREPROCESSOR);
            yybegin(YYINITIAL);
          }
        case 76:
          break;
        case 31:
          {
            addToken(start, zzStartRead + 1, Token.OPERATOR);
            yybegin(YYINITIAL);
          }
        case 77:
          break;
          ...
          if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
            ...
            switch (zzLexicalState) {
              ...
              case STRIKETHROUGH:
                {
                  addToken(start, zzStartRead - 1, Token.OPERATOR);
                  addEndToken(INTERNAL_IN_STRIKETHROUGH);
                  return firstToken;
                }
              case 345:
                break;
              case BOLDITALIC2:
                {
                  ...
                  addEndToken(INTERNAL_IN_BOLDITALIC2);
                  return firstToken;
                }
              case 346:
                break;
              case BOLDITALIC1:
                {
                  addToken(start, zzStartRead - 1, Token.FUNCTION);
                  addEndToken(INTERNAL_IN_BOLDITALIC1);
                  return firstToken;
                }
              case 347:
                break;
              case ITALIC2:
                {
                  ...
                  addEndToken(INTERNAL_IN_ITALIC2);
                  return firstToken;
                }
              case 348:
                break;
              case ITALIC1:
                {
                  addToken(start, zzStartRead - 1, Token.DATA_TYPE);
                  addEndToken(INTERNAL_IN_ITALIC1);
                  return firstToken;
                }
              case 349:
                break;
              ...
              case SYNTAX_HIGHLIGHTING:
                {
                  addToken(start, zzStartRead - 1, Token.PREPROCESSOR);
                  addEndToken(INTERNAL_IN_SYNTAX_HIGHLIGHTING);
                  return firstToken;
                }
              case 352:
                break;
              case INATTR_SINGLE:
                {
                  addToken(
                    start,
                    zzStartRead - 1,
                    Token.MARKUP_TAG_ATTRIBUTE_VALUE
                  );
