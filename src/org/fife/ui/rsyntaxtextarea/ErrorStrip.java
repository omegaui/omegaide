...
public class ErrorStrip extends JPanel {
  ...
  private void refreshMarkers() {
    ...
    for (ParserNotice notice : notices) {
      if (
        notice.getLevel().isEqualToOrWorseThan(levelThreshold) ||
   ...
   */
  private void addMarkersForRanges(
   ...
   */
  public void setMarkerToolTipProvider(
    ErrorStripMarkerToolTipProvider provider
  ) {
  ...
  private class Listener
    ...
    public void propertyChange(PropertyChangeEvent e) {
      ...
      // TODO: Only update "mark occurrences" markers, not all of them.
        ...
        RSyntaxTextArea.MARKED_OCCURRENCES_CHANGED_PROPERTY.equals(propName)
      ) {
        if (getShowMarkedOccurrences()) {
          refreshMarkers();
        }
      ...
      // TODO: Only update "mark all" markers, not all of them.
        ...
        RTextArea.MARK_ALL_OCCURRENCES_CHANGED_PROPERTY.equals(propName)
      ) {
        if (getShowMarkAll()) {
          refreshMarkers();
        }
  ...
  private class Marker extends JComponent {
    ...
    @Override
    public String getToolTipText() {
      return markerToolTipProvider.getToolTipText(
