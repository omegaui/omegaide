...
public class NsisFoldParser implements FoldParser {
  ...
  private static boolean foundEndKeyword(
    char[] keyword,
    Token t,
    Stack<char[]> endWordStack
  ) {
    return (
      t.is(Token.RESERVED_WORD, keyword) &&
      !endWordStack.isEmpty() &&
      ...
      for (int line = 0; line < lineCount; line++) {
        ...
        while (t != null && t.isPaintable()) {
          if (t.isComment()) {
            if (inMLC) {
              ...
              if (t.endsWith(C_MLC_END)) {
                ...
                if (currentFold == null) {
                  ...
                  currentFold =
                    currentFold.createChild(FoldType.COMMENT, mlcStart);
                  currentFold.setEndOffset(mlcEnd);
            ...
            foundEndKeyword(KEYWORD_SECTION_END, t, endWordStack) ||
