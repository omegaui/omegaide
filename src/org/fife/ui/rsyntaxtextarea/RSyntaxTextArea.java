...
public class RSyntaxTextArea extends RTextArea implements SyntaxConstants {
  ...
  public static final String USE_SELECTED_TEXT_COLOR_PROPERTY =
    "RSTA.useSelectedTextColor";
  public static final String VISIBLE_WHITESPACE_PROPERTY =
    "RSTA.visibleWhitespace";

  private static final Color DEFAULT_BRACKET_MATCH_BG_COLOR = new Color(
    234,
    234,
    255
  );
  ...
  public void copyAsStyledText() {
    ...
    StyledTextTransferable contents = new StyledTextTransferable(
      html,
      rtfBytes
    );
  ...
  private static void createRstaPopupMenuActions() {
    ...
    toggleCurrentFoldAction =
      new RSyntaxTextAreaEditorKit.ToggleCurrentFoldAction();
    ...
    collapseAllCommentFoldsAction.setProperties(
      msg,
      "Action.CollapseCommentFolds"
    );

    collapseAllFoldsAction =
      new RSyntaxTextAreaEditorKit.CollapseAllFoldsAction(true);
  ...
  protected final void doBracketMatching() {
    ...
    bracketInfo =
      RSyntaxUtilities.getMatchingBracketPosition(this, bracketInfo);
    if (
      bracketInfo.y > -1 &&
      (
  ...
  public Color getBackgroundForToken(Token token) {
    ...
    if (
      omega.instant.support.BasicCodeHighlighter.canComputeBackground(
        this,
        token
      )
    ) {
      c =
        omega.instant.support.BasicCodeHighlighter.computeBackgroundColor(
          token
        );
      if (c != null) return c;
    }
  ...
  public Font getFontForTokenType(int type) {
    ...
    if (
      type == TokenTypes.RESERVED_WORD_2 ||
    ...
    if (f == null) {
      f =
        new Font(
          omega.utils.UIManager.fontName,
          Font.BOLD,
          omega.utils.UIManager.fontSize
        );
    }
  ...
  public Color getForegroundForToken(Token t) {
    ...
    if (
      omega.instant.support.BasicCodeHighlighter.canComputeForeground(this, t)
    ) {
      Color c = omega.instant.support.BasicCodeHighlighter.computeForegroundColor(
        t
      );
      if (c != null) return c;
    }
  ...
  public void setSecondaryLanguageBackground(int index, Color color) {
    ...
    if (
      (color == null && old != null) || (color != null && !color.equals(old))
    ) {
    ...
    public void mouseMoved(MouseEvent e) {
      ...
      if ((e.getModifiersEx() & linkScanningMask) == linkScanningMask) {
        ...
        if (t != null && t.isHyperlink()) {
          ...
          LinkGeneratorResult newResult = linkGenerator.isLinkAtOffset(
            RSyntaxTextArea.this,
            offs
          );
          if (newResult != null) {
