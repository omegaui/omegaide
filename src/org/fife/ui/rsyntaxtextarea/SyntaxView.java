...
public class SyntaxView
  ...
  private float getLineWidth(int lineNumber) {
    Token tokenList =
      ((RSyntaxDocument) getDocument()).getTokenListForLine(lineNumber);
    return RSyntaxUtilities.getTokenListWidth(
      tokenList,
  ...
  public int getNextVisualPositionFrom(
    ...
    return RSyntaxUtilities.getNextVisualPositionFrom(
      pos,
      b,
      a,
      direction,
