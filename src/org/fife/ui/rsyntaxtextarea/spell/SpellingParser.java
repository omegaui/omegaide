...
public class SpellingParser
   ...
   */
  public static SpellingParser createEnglishSpellingParser(
    File zip,
    boolean american
  ) throws IOException {
  ...
  public static SpellingParser createEnglishSpellingParser(
    ...
    try (ZipFile zf = new ZipFile(zip)) {
      ...
      if (american) {
        others =
          new ArrayList<>(
            Arrays.asList("color", "labeled", "center", "ize", "yze")
          );
      } else { // British
        others =
          new ArrayList<>(
            Arrays.asList("colour", "labelled", "centre", "ise", "yse")
          );
      }
      ...
      switch (operation) {
        ...
        case ADD:
          ...
          if (sc.addToDictionary(word)) {
            ...
            SpellingParserEvent se = new SpellingParserEvent(
              this,
              textArea,
              SpellingParserEvent.WORD_ADDED,
              word
            );
        ...
        case IGNORE:
          ...
          SpellingParserEvent se = new SpellingParserEvent(
            this,
            textArea,
            SpellingParserEvent.WORD_IGNORED,
            word
          );
          fireSpellingParserEvent(se);
          break;
  ...
  public ParseResult parse(RSyntaxDocument doc, String style) {
    ...
    if (style == null || SyntaxConstants.SYNTAX_STYLE_NONE.equals(style)) {
      ...
      SpellCheckableTokenIdentifier scti = getSpellCheckableTokenIdentifier();
  ...
  public void spellingError(SpellCheckEvent e) {
    ...
    SpellingParserNotice notice = new SpellingParserNotice(
      this,
      text,
      line,
      offs,
  ...
  private static class SpellingParserNotice extends DefaultParserNotice {
    ...
    public String getToolTipText() {
      ...
      if (suggestions == null || suggestions.size() == 0) {
        ...
        if (Character.isUpperCase(word.charAt(0))) {
          for (Word suggestion : suggestions) {
            ...
            suggestion.setWord(
              Character.toUpperCase(oldSug.charAt(0)) + oldSug.substring(1)
            );
          }
        }
      ...
      if (sp.getAllowAdd()) {
        sb
          .append("<img src='add.png' width='16' height='16'>&nbsp;")
          .append("<a href='")
          .append(ADD)
          .append("://")
          .append(word)
      ...
      if (sp.getAllowIgnore()) {
        ...
        sb
          .append("<img src='cross.png' width='16' height='16'>&nbsp;")
          .append("<a href='")
          .append(IGNORE)
          .append("://")
          .append(word)
