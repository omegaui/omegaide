...
public class CompletionCellRenderer extends DefaultListCellRenderer {
  ...
  private String createParamColor() {
    return Util.isLightForeground(getForeground())
      ? Util.getHexString(Util.getHyperlinkForeground())
      : "#aa0077";
  }
  ...
  public Component getListCellRendererComponent(
    ...
    this.realBG =
      altBG != null && (index & 1) == 1 ? altBG : list.getBackground();
   ...
   * @param hasFocus Whether the item has focus.
   */
  protected void prepareForMarkupTagCompletion(
    JList list,
   ...
   * @param hasFocus Whether the item has focus.
   */
  protected void prepareForOtherCompletion(
    JList list,
    Completion c,
    int index,
    boolean selected,
   ...
   * @param hasFocus Whether the item has focus.
   */
  protected void prepareForTemplateCompletion(
    JList list,
  ...
  protected void setIconWithDefault(Completion completion, Icon defaultIcon) {
    ...
    setIcon(
      icon != null ? icon : (defaultIcon != null ? defaultIcon : emptyIcon)
    );
  }
