...
public class DoubleMeta implements Transformator {
   ...
   * @param main
   */
  private static final void MetaphAdd(StringBuilder primary, String main) {
    if (main != null) {
      primary.append(main);
    }
  }

  private static final void MetaphAdd(StringBuilder primary, char main) {
    primary.append(main);
  }
   ...
   * @return
   */
  private static final boolean stringAt(
    String string,
    int start,
    int length,
    String[] list
    ...
    if (
      (start < 0) || (start >= string.length()) || list.length == 0
    ) return false;
    String substr = string.substring(start, start + length);
    for (String s : list) {
      if (s.equals(substr)) return true;
    }
    return false;
  }
  ...
  public final String transform(String word) {
    ...
    if (stringAt(in, 0, 2, myList)) current += 1;
    if (in.charAt(0) == 'X') {
      MetaphAdd(primary, 'S');
      current += 1;
    }
    while (current < length) {
      switch (in.charAt(current)) {
        ...
        case 'U':
        case 'Y':
          if (current == 0) MetaphAdd(primary, 'A');
          current += 1;
          break;
        case 'B':
          MetaphAdd(primary, 'P');
          if (in.charAt(current + 1) == 'B') current += 2; else current += 1;
          break;
        case '\u00C7':
          MetaphAdd(primary, 'S');
          current += 1;
        ...
        case 'C':
          ...
          if (stringAt(in, current, 2, list5)) {
            ...
            if (
              ...
              if (current > 0) {
                if (stringAt(in, 0, 2, list16)) MetaphAdd(
                  primary,
                  'K'
                ); else MetaphAdd(primary, 'X');
              } else {
                MetaphAdd(primary, 'X');
              }
            }
          ...
          if (
            stringAt(in, current, 2, list20) &&
            !((current == 1) && in.charAt(0) == 'M')
          ) {
            if (
              stringAt(in, current + 2, 1, list21) &&
              !stringAt(in, current + 2, 2, list22)
            ) {
              if (
                ((current == 1) && (in.charAt(current - 1) == 'A')) ||
                stringAt(in, (current - 1), 5, list23)
              ) MetaphAdd(primary, "KS"); else MetaphAdd(primary, 'X');
              current += 3;
              break;
            } else {
              MetaphAdd(primary, 'K');
          ...
          MetaphAdd(primary, 'K');
          if (stringAt(in, current + 1, 2, list27)) current += 3; else if (
        ...
        case 'D':
          ...
          break;
        case 'F':
          if (in.charAt(current + 1) == 'F') current += 2; else current += 1;
          MetaphAdd(primary, 'F');
          break;
        case 'G':
          if (in.charAt(current + 1) == 'H') {
            ...
            if (current < 3) {
              if (current == 0) {
                if (in.charAt(current + 2) == 'I') MetaphAdd(
                  primary,
                  'J'
                ); else MetaphAdd(primary, 'K');
                current += 2;
                break;
              }
            }
            if (
              ...
              if (
                ...
                if ((current > 0) && (in.charAt(current - 1) != 'I')) MetaphAdd(
                  primary,
                  'K'
                );
              }
          ...
          if (in.charAt(current + 1) == 'N') {
            if ((current == 1) && isVowel(in, 0, length) && !isSlavoGermaic) {
              ...
              if (
                !stringAt(in, current + 2, 2, list37) &&
          ...
          if (
            (
              stringAt(in, current + 1, 2, list40) ||
              (in.charAt(current + 1) == 'Y')
            ) &&
          ...
          if (
            stringAt(in, current + 1, 1, list44) ||
            stringAt(in, current - 1, 4, list45)
          ) {
            if (
              stringAt(in, 0, 4, list46) ||
          ...
          if (in.charAt(current + 1) == 'G') current += 2; else current += 1;
          MetaphAdd(primary, 'K');
          break;
        case 'H':
          if (
            ((current == 0) || isVowel(in, current - 1, length)) &&
        ...
        case 'J':
          ...
          if ((current == 0) && !stringAt(in, current, 4, list53)) {
            ...
            if (
              ...
              if (current == last) {
                ...
                if (
                  !stringAt(in, current + 1, 1, list54) &&
          ...
          if (in.charAt(current + 1) == 'J') current += 2; else current += 1;
          break;
        case 'K':
          if (in.charAt(current + 1) == 'K') current += 2; else current += 1;
          MetaphAdd(primary, 'K');
          break;
        case 'L':
        ...
        case 'M':
          if (
            (
              stringAt(in, current - 1, 3, list60) &&
          ...
          break;
        case 'N':
          if (in.charAt(current + 1) == 'N') current += 2; else current += 1;
          MetaphAdd(primary, 'N');
          break;
        case '\u00D1':
          current += 1;
        ...
        case 'P':
          ...
          if (stringAt(in, current + 1, 1, list62)) current +=
            2; else current += 1;
          MetaphAdd(primary, 'P');
          break;
        case 'Q':
          if (in.charAt(current + 1) == 'Q') current += 2; else current += 1;
          MetaphAdd(primary, 'K');
          break;
        case 'R':
          if (
            ...
            //            MetaphAdd(primary, "");
          } else MetaphAdd(primary, 'R');
          if (in.charAt(current + 1) == 'R') current += 2; else current += 1;
          break;
        case 'S':
          ...
          if (stringAt(in, current, 2, list67)) {
            if (stringAt(in, current + 1, 4, list68)) MetaphAdd(
              primary,
              'S'
            ); else MetaphAdd(primary, 'X');
            current += 2;
          ...
          if (
            stringAt(in, current, 3, list69) || stringAt(in, current, 4, list70)
          ) {
            MetaphAdd(primary, 'S');
            current += 3;
            break;
          ...
          if (
            ((current == 0) && stringAt(in, current + 1, 1, list71)) ||
            stringAt(in, current + 1, 1, list72)
          ) {
            MetaphAdd(primary, 'S');
            if (stringAt(in, current + 1, 1, list73)) current +=
              2; else current += 1;
            break;
          }
          if (stringAt(in, current, 2, list74)) {
            if (in.charAt(current + 2) == 'H') if (
              stringAt(in, current + 3, 2, list75)
            ) {
          ...
          if ((current == last) && stringAt(in, current - 2, 2, list78)) {
            //MetaphAdd(primary, "");
          } else MetaphAdd(primary, 'S');
          if (stringAt(in, current + 1, 1, list79)) current +=
            2; else current += 1;
          break;
        case 'T':
          ...
          if (
            stringAt(in, current, 2, list82) || stringAt(in, current, 3, list83)
          ) {
            if (
              stringAt(in, (current + 2), 2, list84) ||
          ...
          break;
        case 'V':
          if (in.charAt(current + 1) == 'V') current += 2; else current += 1;
          MetaphAdd(primary, 'F');
          break;
        case 'W':
          ...
          if (
            ((current == last) && isVowel(in, current - 1, length)) ||
        ...
        case 'X':
          ...
          if (stringAt(in, current + 1, 1, list95)) current +=
            2; else current += 1;
          break;
        case 'Z':
          if (in.charAt(current + 1) == 'H') {
          ...
          if (in.charAt(current + 1) == 'Z') current += 2; else current += 1;
          break;
        default:
          current += 1;
      }
